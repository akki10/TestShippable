...
//       	List<Issue> repo_issues_7days = issueService.getIssues(repoInfo[0], repoInfo[1], null);
       	...
       	repo_status.addProperty("issues24Hr", openIssues24Hr);
       	repo_status.addProperty("issues7Days", openIssues7days);
       	repo_status.addProperty("issuesOther", openIssuesOthers);
       	out.print(repo_status.toString());
